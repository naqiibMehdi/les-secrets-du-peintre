<x-layout title="Accueil">
  ...
  <x-slot name="cdnScript">
    ...
    <div class="hero-left">
      ...
      <p class="hero-text">Artisans peintre de métier et consultant technique, je met mon savoir-faire de vos projets.
        Riche d'une solide expérience dans l'artisanat, j'allie créativité, précision et maitrise technique pour donner
        vie aux espaces et au surfaces. <br>Entre art, technique et artisanat, chaque projet devient une réalisation
  ...
  <section class="section-marc">
    ...
    <div class="marc-text-col">
      ...
      <p class="marc-intro">
        ...
        au service de ceux qui veulent apprendre. Que vous soyez artisan en reconversion, professionnel souhaitant
  ...
  <section class="section-partenaires">
    ...
    <div class="main-carousel">
      <div class="carousel-cell">
        <img src="https://cache.marieclaire.fr/data/photo/w2000_ci/5g/appliquer-peinture-au-mur.jpg" alt="Image 1"
  ...
  <section class="section-avis">
    ...
    <div class="avis-grid">
      <div class="avis-card">
        <div class="quote">"</div>
        <p>Formation airless incroyable. En 2 jours j'avais la technique pour travailler proprement. Marc est pédagogue
      ...
      <div class="avis-card">
        <div class="quote">"</div>
        <p>Le diagnostic travaux m'a évité une erreur coûteuse. En 1h30, j'avais une vision claire de mon chantier et
          des priorités.</p>
        <div class="avis-foot">
          <div class="av-avatar">🏠</div>
          <div>
      ...
      <div class="avis-card">
        <div class="quote">"</div>
        <p>L'accompagnement sur 1 mois est idéal pour les projets complexes. Marc a été présent à chaque étape, toujours
          de bon conseil.</p>
        <div class="avis-foot">
          <div class="av-avatar">🔧</div>
          <div>
